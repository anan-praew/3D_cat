...
class Scene():
    r = 10;
    def __init__(self, app,front_back = -90, left_right=0, cw_ccw = 0,fb_deg = 1, lr_deg=0, cw_deg = 0):
        self.app = app
    ...
    def move(self):
        ...
        if self.front_back > 360:
            self.front_back = self.front_back-360
