...
class Scene():
    r = 10;
    def __init__(self, app,front_back = -90, left_right=0, cw_ccw = 0,fb_deg = 0, lr_deg=1, cw_deg = 0):
        self.app = app
    ...
    def move(self):
        ...
        if self.left_right > 360:
            self.left_right = self.left_right-360
